  ...
  return (
    <div name='contact' className=' w-full h-screen bg-[#0a192f] flex justify-center items-center p-4 '>
        <form method='PIST' action='https://getform.io/f/01696395-469b-4f94-b916-a1387fa28e7e' className='flex flex-col max-w-[600px] w-full'>
            ...
            <button className='cursor-not-allowed text-white border-2 hover:bg-pink-600 hover:border-pink-600 px-4 py-3 my-4 mx-auto flex items-center '>Lets colab (submission disabled)</button>
        </form>
    </div> 
  )
}
